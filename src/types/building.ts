...
export interface BuildingLocation {
  ...
  country: string; latitude?: number; longitude?: number; street?: string;
}

export interface Building {
  _id: string; name: string; slug?: string; type: BuildingType; status: BuildingStatus;
  location: BuildingLocation; ownerId: string; managerId?: string;
  totalUnits: number; totalFloors: number; sqft?: number; lift: boolean; helipad: boolean;
  nearAirport?: string; nearRailwayStation?: string; nearBusStand?: string; nearPark?: string;
  amenities?: string[]; images?: string[]; documents?: string[]; description?: string;
  yearOfBuild?: string; isPublished: boolean; isFeatured: boolean; viewCount?: number;
...
export interface Floor {
  _id: string; buildingId: string; floorNumber: number; name: string; totalUnits: number;
  status: FloorStatus; description?: string; createdAt?: string; updatedAt?: string;
}
...
export interface Unit {
  ...
  isOccupied: boolean; amenities?: string[]; bedrooms: number; bathrooms: number;
  status: UnitStatus; tokenAmount?: number; viewCount?: number;
  createdAt?: string; updatedAt?: string;
}
